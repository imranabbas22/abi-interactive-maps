      ...
      <aside className="w-72 bg-background border-r border-white/5 flex flex-col flex-shrink-0 overflow-hidden">
        ...
        <div className="p-4 border-b border-white/5 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="text-xs px-2 py-1 rounded bg-surface-elevated/60 text-text-secondary hover:text-primary border border-white/5 hover:border-primary/30 transition-all">← Back</Link>
          </div>
          <select value={selectedMap} onChange={(e) => window.location.href = `/view/${e.target.value}`}
